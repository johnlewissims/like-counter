...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('ejin/like-counter', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_UserCard__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'infoItems', function (items) {
    ...
    var comments = this.props.user.data.attributes.commentCount; //console.log(this.props.user.data.id);

    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.request({
      url: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('apiUrl') + '/users/' + this.props.user.id() + '/like-count',
      method: 'GET'
    }).then(function (data) {
      console.log(data);
      items.add('ejin-like-counter', m('span', [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_6___default()('fas fa-thumbs-up'), ' ', data, ' Likes'])); // items.add('ejin-like-counter-2', m('span', [icon('fas fa-comments'), ' ', comments, ' Comments']));
    });
  });
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'headerItems', function (items) {
    ...
    var likes = 233;
    var comments = 4; //app.store.find('users', this.props.post.data.relationships.user.data.id).then((val) => console.log(val));
