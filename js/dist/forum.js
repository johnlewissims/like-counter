...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('ejin/like-counter', function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_UserCard__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'infoItems', function (items) {
    ...
    // }));
    var likes = 233;
    var comments = this.props.user.data.attributes.commentCount; //items.add('ejin-like-counter', m('span', [icon('fas fa-thumbs-up'), ' ', likes, ' Likes Recieved']));

    items.add('ejin-like-counter-2', m('span', [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_5___default()('fas fa-comments'), ' ', comments, ' Comments']));
  });
});
