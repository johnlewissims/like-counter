...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('ejin/like-counter', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_UserCard__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'infoItems', function (items) {
    var caption = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('like-counter.caption');
    var likes = this.props.user.data.attributes.ejinLikeCount;
    items.add('ejin-like-counter', m('span', likes, ' ', caption, ' ', [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_6___default()('fas fa-thumbs-up')]));
  });
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'headerItems', function (items) {
    if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('like-counter.display_under_comments') == 1) {
      var likes = this.props.post.data.attributes.ejinLikeCount;
      items.add('ejin-like-counter-post', m('span', likes, ' ', [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_6___default()('fas fa-thumbs-up')]));
    }
  });
});
